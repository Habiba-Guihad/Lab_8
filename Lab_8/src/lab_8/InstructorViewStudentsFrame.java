...
public class InstructorViewStudentsFrame extends javax.swing.JFrame {
    ...
    private Instructor instructor; // current instructor

    public InstructorViewStudentsFrame(Instructor instructor) {
    ...
    this.dispose();
    new InstructorDashboardFrame(instructor).setVisible(true);
