...
public class TakeQuizFrame extends javax.swing.JFrame {
    ...
    public TakeQuizFrame(Student student, Course course, Quiz quiz, JsonDatabaseManager db, QuizManager quizManager) {
        initComponents();
...
// Save attempt using QuizManager
        quizManager.saveAttempt(student.getUserId(), selectedCourse.getCourseId(), quiz, score);
